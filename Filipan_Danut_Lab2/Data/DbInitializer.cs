...
new Publishers{PublisherName="Paralela 45", Adress="Str. Cascadelor, nr. 22, Cluj-Napoca"},
            ...
            {
 new PublishedBooks {BookID = books.Single(c => c.Title == "Maytrei" ).ID, PublisherID = publisher.Single(i => i.PublisherName == "Humanitas").ID},
 new PublishedBooks {BookID = books.Single(c => c.Title == "Enigma Otiliei" ).ID, PublisherID = publisher.Single(i => i.PublisherName == "Humanitas").ID},
 new PublishedBooks {BookID = books.Single(c => c.Title == "Baltagul" ).ID,PublisherID = publisher.Single(i => i.PublisherName =="Nemira").ID},
 new PublishedBooks {BookID = books.Single(c => c.Title == "Fata de hartie" ).ID, PublisherID = publisher.Single(i => i.PublisherName == "Paralela 45").ID},
 new PublishedBooks {BookID = books.Single(c => c.Title == "Panza de paianjen" ).ID, PublisherID = publisher.Single(i => i.PublisherName == "Paralela 45").ID},
 new PublishedBooks {BookID = books.Single(c => c.Title == "De veghe in lanul desecara" ).ID, PublisherID = publisher.Single(i => i.PublisherName == "Paralela45").ID},
            };
